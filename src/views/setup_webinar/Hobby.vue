    ...
    >
      <template v-slot:top>
        <v-toolbar flat dense color="grey lighten-2">
          <v-toolbar-title>Setup Hobi</v-toolbar-title>
...
export default {
  ...
  computed: {
    ...
    formTitle() {
      return this.editedIndex === -1 ? "Tambah Hobi" : "Edit Hobi";
    },
  },
  methods: {
    ...mapActions({
    ...
    async saveMaster() {
      ...
      formData.set("hobby", this.form1.hobby.toUpperCase());
      formData.set("created_by", this.user.id);

      await this.axios
        .post("/setup-webinar/v1/hobby", formData, {
          headers: {
            Authorization: "Bearer " + this.user.api_token,
          },
        })
    ...
    async updateMaster() {
      ...
      await this.axios
        .put(
          "/setup-webinar/v1/hobby",
          {
            id: this.form1.id,
            hobby: this.form1.hobby.toUpperCase(),
