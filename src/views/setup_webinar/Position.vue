    ...
    >
      <template v-slot:top>
        <v-toolbar flat dense color="grey lighten-2">
          <v-toolbar-title>Setup Posisi</v-toolbar-title>
...
export default {
  ...
  computed: {
    ...
    formTitle() {
      return this.editedIndex === -1 ? "Tambah Posisi" : "Edit Posisi";
    },
  },
  methods: {
    ...mapActions({
    ...
    async saveMaster() {
      ...
      formData.set("position", this.form1.position.toUpperCase());
    ...
    async updateMaster() {
      ...
      await this.axios
        .put(
          "/setup-webinar/v1/position",
          {
            id: this.form1.id,
            position: this.form1.position.toUpperCase(),
