    ...
    >
      <template v-slot:top>
        <v-toolbar flat dense color="grey lighten-2">
          <v-toolbar-title>Setup Pekerjaan</v-toolbar-title>
...
export default {
  ...
  computed: {
    ...
    formTitle() {
      return this.editedIndex === -1 ? "Tambah Pekerjaan" : "Edit Pekerjaan";
    },
  },
  methods: {
    ...mapActions({
    ...
    async saveMaster() {
      ...
      formData.set("job", this.form1.job.toUpperCase());
    ...
    async updateMaster() {
      ...
      await this.axios
        .put(
          "/setup-webinar/v1/job",
          {
            id: this.form1.id,
            job: this.form1.job.toUpperCase(),
